...
## Main
Насколько я понял, ты писал все в процедурном стиле, поэтому опущу моменты с разбиением на классы. Если вкратце, то с разбиением у тебя ушли бы все статичные методы, а переменные в методе `startGame` ушли бы в поля определенных классов.
